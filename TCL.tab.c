...
{
      18,     0,    -1,     3,    16,    19,    15,    -1,     4,    16,
      19,    15,    -1,     5,    16,    19,    15,    -1,    16,    19,
      15,    -1,    16,    19,    15,     6,    16,    19,    15,    -1,
      16,    19,    15,     7,    16,    19,    15,    -1,    16,    19,
      15,     8,    16,    19,    15,    -1,    16,    19,    15,     9,
      16,    19,    15,    -1,    10,    16,    19,    15,    -1,    14,
      16,    19,    15,    -1,    11,    -1,    12,    -1,    13,    -1
};
...
{
  "$end", "error", "$undefined", "TOKEN_ROOT", "TOKEN_PLUS",
  "TOKEN_MINUS", "TOKEN_AND", "TOKEN_OR", "TOKEN_UNTIL", "TOKEN_WNTIL",
  "TOKEN_NEXT", "TOKEN_TRUE", "TOKEN_FALSE", "TOKEN_ATOMIC", "TOKEN_NOT",
  "TOKEN_RIGHT", "TOKEN_LEFT", "$accept", "state_formula", "expression", YY_NULL
};
#endif
...
#line 39 "TCL.y"
    {
								...
								(yyvsp[(3) - (4)].ptr)->ins.push_back((yyvsp[(1) - (4)].ptr));
								ROOT_ptr=(yyvsp[(1) - (4)].ptr);
							}
    break;
...
#line 63 "TCL.y"
    {
    	...
    	(yyvsp[(4) - (7)].ptr)->outs.push_back((yyvsp[(6) - (7)].ptr));
    	(yyvsp[(2) - (7)].ptr)->ins.push_back((yyvsp[(4) - (7)].ptr));
    	(yyvsp[(6) - (7)].ptr)->ins.push_back((yyvsp[(4) - (7)].ptr));
